...
export function middleware() {
    ...
    const csp = [
        "default-src 'self'",
        "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.youtube.com http://www.youtube.com https://s.ytimg.com",
        "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
        "font-src 'self' https://fonts.gstatic.com",
        "img-src 'self' data: https://i.ytimg.com https://*.googleusercontent.com https://is1-ssl.mzstatic.com",
        "frame-src https://www.youtube.com http://www.youtube.com https://www.youtube-nocookie.com",
